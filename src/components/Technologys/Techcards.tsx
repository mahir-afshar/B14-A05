...
type TechtechsProps = {
  tech: Tech
  // saved: Tech[]
  // onSaved: (techs: Tech) => void
}

const Techtechs = ({ tech }: TechtechsProps) => {
  return (
    <div>
        ...
        >
          ...
          <button className="mt-8 w-full rounded-full bg-black text-white py-2 text-sm font-medium transition hover:bg-pink-500 hover:text-white">
            Add to Stack
          </button>
        </div>
